...
def get_db_connection():
    ...
    try:
        ...
        logger.error(f"Check if the database user exists and has proper permissions.")
        logger.error(f"Database URL format should be: postgresql://username:password@host:port/dbname")
        sys.exit(1)
