...
def register_routes(app, get_recommender):
    ...
    def profile():
        ...
        # Add this after any database query that retrieves manga data for profiles or recommendations
        # This ensures field names are consistent
        for item in personalized_recs:
            # If img_url exists but image_url doesn't, copy the value
